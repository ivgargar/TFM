package org.eclipse.leshan.client.tfm;
...
public class LeshanClientTfm {

    private static final Logger LOG = LoggerFactory.getLogger(LeshanClientTfm.class);

    private final static String[] modelPaths = new String[] { "3322.xml" };

    private static final int OBJECT_ID_LOAD_SENSOR = 3322;
    private final static String DEFAULT_ENDPOINT = "LeshanClientTfm";
    private final static String USAGE = "java -jar leshan-client-tfm.jar [OPTION]\n\n";
    ...
    public static void createAndStartClient(String endpoint, String localAddress, int localPort, boolean needBootstrap,
        ...
        initializer.setInstancesForObject(OBJECT_ID_LOAD_SENSOR, new RandomLoadSensor());
        List<LwM2mObjectEnabler> enablers = initializer.create(SECURITY, SERVER, DEVICE, LOCATION,
                OBJECT_ID_LOAD_SENSOR);
